            ...
            <div className={classes.heading}>
                ...
                <div className={classes.dropdown}>
                    <div className={classes.logo}>
                        ...
                        <Typography variant='body1' style={{ color: "red" }}>Change Password</Typography>
                    </div>
            ...
            <div id="collapse">
                ...
                <form action="/" method="post" className={classes.form}>
                  <div className={classes.formField}>
                    <label htmlFor="oldPassword" style={{color:"gray", marginRight:"40px",width:"40%"}}>Old Password</label>
                    <input type="text" id="oldPassword" className={classes.formInput}/>
                  </div>
                  <div className={classes.formField}>
                    <label htmlFor="newPassword" style={{color:"gray", marginRight:"40px",width:"40%"}}>New Password</label>
                    <input type="text" id="newPassword" className={classes.formInput}/>
                  </div>
                  <div className={classes.formField}>
                    <label htmlFor="confirmPassword" style={{color:"gray", marginRight:"40px",width:"40%"}}>Confirm Password</label>
                    <input type="text" id="confirmPassword" className={classes.formInput}/>
                  </div>
                </form>

                <div className={classes.buttons}>
                  <Button variant='contained' color="primary" style={{marginRight:"10px"}}>Change</Button>
